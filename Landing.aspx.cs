...
public partial class Landing : System.Web.UI.Page
{
    ...
    public static List<string> SearchCustomers(string prefixText)
    {
        ...
        //using (SqlConnection con = new SqlConnection("uid=bibek;password=Amphi12356;server=43.255.152.25;database=Grossary"))
        using (SqlConnection con = new SqlConnection("uid=sa;password=sa@123;server=localhost;database=Grossary"))
        {
